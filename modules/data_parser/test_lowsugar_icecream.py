...
from ultimate_parser import UltimateParser

# 휘광님이 제공한 저당 아이스크림 데이터
test_data = """
...
def main():
    ...
    print("🍦 저당 아이스크림 데이터 테스트")
    print("📋 쿠팡 저당 아이스크림 파싱 중...")
    ...
    for product in products:
        product['category'] = 'lowsugar_icecream'
        product['category_name'] = '저당 아이스크림'
    ...
    if products:
        ...
        print(f"\n✅ 저당 아이스크림 파싱 완료! 파일: {filepath}")
        print("🎯 새로운 카테고리 데이터도 완벽하게 파싱됩니다!")
        print("📋 WhatToEat 룰렛에 저당 아이스크림 카테고리 추가 가능!")
    else:
